...
global $post;
$page_id = $post->ID;
$sc_blog_index_id = get_option('page_for_posts');
if ($sc_blog_index_id > 0) {
	$page_id = $sc_blog_index_id;
}
				...
				<div class="container">
					...
					<div class="actions">
						<div>
							...
							<div class="comments"><i class="fa fa-comment"></i><a href="<?php comments_link(); ?>"><?php comments_number('0','1','%'); ?></a></div>
