...
if (is_user_logged_in()) {
	if ( current_user_can( 'manage_options' ) ) {
		...
		echo "<p class='alert alert-danger'>" . esc_html__('This page is not accessible when a user is logged in. You are seeing this warning because you have administrative privileges, otherwise you would be redirected to home. To access this page properly, please log out.', 'socialchef') . "</p>";
