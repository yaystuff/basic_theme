...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'id' => 'copyright_footer',
		'std' => '&copy; socialchef.com 2016. All rights reserved.',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('Terms and conditions page url', 'socialchef'),
		'desc' => __('Page that displays terms and conditions for your site.', 'socialchef'),
		'id' => 'terms_page_url_id',
		'std' => 'three',
		'type' => 'select',
		'class' => 'mini', //mini, tiny, small
		'options' => $pages_array);		
	...
	$options[] = array(
		'name' => __('Disable ingredient amount fractions', 'socialchef'),
		'desc' => __('Disable converting decimal values of ingredient amounts to fractions', 'socialchef'),
		'id' => 'disable_amount_fractions',
		'std' => '0',
		'type' => 'checkbox');				
	...
	$options[] = array(
		'name' => __('Enable recipe meta', 'socialchef'),
		'desc' => __('Enable use of meal course, prep time, cook time, serving, difficulty across the theme', 'socialchef'),
		'id' => 'enable_recipe_meta',
		'std' => '1',
		'type' => 'checkbox');		
	...
	$options[] = array(
		'name' => __('Enable instructions info', 'socialchef'),
		'desc' => __('Enable use of instructions across the theme', 'socialchef'),
		'id' => 'enable_instructions',
		'std' => '1',
		'type' => 'checkbox');	
	...
	if ($sc_theme_globals->enable_instructions()) {
		$options[] = array(
			'name' => __('Enable images for instructions', 'socialchef'),
			'desc' => __('Enable use of images for each instruction', 'socialchef'),
			'id' => 'enable_instruction_images',
			'std' => '0',
			'type' => 'checkbox');	
	}	
		
	$options[] = array(
		'name' => __('Enable ingredient info', 'socialchef'),
		'desc' => __('Enable use of ingredient info across the theme', 'socialchef'),
