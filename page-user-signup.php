...
if (SocialChef_Theme_Utils::is_buddypress_active()) {
	if ( current_user_can( 'manage_options' ) ) {
		...
		echo "<p class='alert alert-danger'>" . esc_html__('When using BuddyPress plugin please do not use this template for the registration page. Instead, use the "Default Template". Of course, please also make sure you have gone to Settings -> BuddyPress -> Pages and connected the dropdowns properly.', 'socialchef') . "</p>";
